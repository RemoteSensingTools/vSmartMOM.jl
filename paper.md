...
![Sample scattering phase functions of aerosols (I $\rightarrow$ I and the I $\rightarrow$ Q transition), calculated using Scattering.jl ($\mu$ = 10.0 $\mu$m, $\sigma$ = 1.1 $\mu$m, $n_r$ = 1.3, $n_i$ = 0.0, $\lambda$ = 0.65 $\mu$m)](joss_3.png)
