...
q3 = plot!(1e7./ν, 100*(R[3,2,:].-RnoRS[3,2,:].+ieR[3,2,:])./(RnoRS[3,2,:]), linecolor=:green, linewidth=0.5, alpha=0.5, xlabel = "λ [nm]", xlims=(755,775))
...
p4 = plot!(1e7./ν, (ieR[3,1,:]).*convfct, linecolor=:green, linewidth=0.5, alpha=0.5, xlims=(755,775))#, xlabel = "λ [nm]", xlims=(755,775))
...
p5 = plot!(1e7./ν, 100*(ieR[3,1,:])./(RnoRS[3,1,:]), linecolor=:green, linewidth=0.5, alpha=0.5, xlabel = "λ [nm]", xlims=(755,775))
...
q4 = plot!(1e7./ν, (ieR[3,2,:]).*convfct, linecolor=:green, linewidth=0.5, alpha=0.5, xlims=(755,775))
...
q5 = plot!(1e7./ν, 100*(ieR[3,2,:])./(RnoRS[3,2,:]), linecolor=:green, linewidth=0.5, alpha=0.5, xlabel = "λ [nm]", xlims=(755,775))
