...
## /net/fluo/data2/software/Julia/julia-1.11.3/bin/julia --project=/home/sanghavi/code/github/vSmartMOM.jl/ /home/sanghavi/code/github/vSmartMOM.jl/test/benchmarks/test_creategrid_O2Aband_RamanSIF.jl &

FT = Float64

# Load YAML files into parameter struct
parameters = 
    parameters_from_yaml("/home/sanghavi/code/github/vSmartMOM.jl/test/test_parameters/O2_parameters2_SIF_grid_all_layers.yaml");
    ...
    for iρ = 1:1 #21 #1:15 #3 #1:15
        for iA = 2:2 #14
            ...
            for vctr = 1:length(model.params.vaz)
                ...
                # No SIF
                fname0 = "/home/sanghavi/data/RamanSIFgrid/tests/testnofr_rayl_sza"*sza_str*"_vza"*vza_str*"_vaz"*vaz_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_nors_ABO2.dat"
                fname1 = "/home/sanghavi/data/RamanSIFgrid/tests/testnofr_rayl_sza"*sza_str*"_vza"*vza_str*"_vaz"*vaz_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_rrs_ABO2.dat"
