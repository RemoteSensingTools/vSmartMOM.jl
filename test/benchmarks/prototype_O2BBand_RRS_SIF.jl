...
parameters = 
    parameters_from_yaml("test/test_parameters/O2Parameters1_SIF.yaml");
...
#=
rayl_sza70_vza00_rrs_BBO2 = [ν R[1,1,:] R[1,2,:] R[1,3,:] ieR[1,1,:] ieR[1,2,:] ieR[1,3,:]]
rayl_sza70_vza00_nors_BBO2 = [ν RnoRS[1,1,:] RnoRS[1,2,:] RnoRS[1,3,:]]
rayl_sza70_vza00_nors_BBO2_Δp = [ν RnoRS[1,1,:] RnoRS[1,2,:] RnoRS[1,3,:]]
rayl_sza70_vza00_nors_BBO2_SIF = [ν RnoRS[1,1,:] RnoRS[1,2,:] RnoRS[1,3,:]]

rayl_sza30_vza00_rrs_BBO2 = [ν R[1,1,:] R[1,2,:] R[1,3,:] ieR[1,1,:] ieR[1,2,:] ieR[1,3,:]]
rayl_sza30_vza00_nors_BBO2 = [ν RnoRS[1,1,:] RnoRS[1,2,:] RnoRS[1,3,:]]
rayl_sza30_vza00_nors_BBO2_Δp = [ν RnoRS[1,1,:] RnoRS[1,2,:] RnoRS[1,3,:]]
rayl_sza30_vza00_nors_BBO2_SIF = [ν RnoRS[1,1,:] RnoRS[1,2,:] RnoRS[1,3,:]]

writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_rrs_BBO2.dat", rayl_sza70_vza00_rrs_BBO2)
writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_nors_BBO2.dat", rayl_sza70_vza00_nors_BBO2)
writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_nors_BBO2_dp.dat", rayl_sza70_vza00_nors_BBO2_Δp)
writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_nors_BBO2_SIF.dat", rayl_sza70_vza00_nors_BBO2_SIF)

writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_rrs_BBO2.dat", rayl_sza30_vza00_rrs_BBO2)
writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_nors_BBO2.dat", rayl_sza30_vza00_nors_BBO2)
writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_nors_BBO2_dp.dat", rayl_sza30_vza00_nors_BBO2_Δp)
writedlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_nors_BBO2_SIF.dat", rayl_sza30_vza00_nors_BBO2_SIF)

rayl_sza70_vza00_rrs_BBO2 = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_rrs_BBO2.dat")
rayl_sza70_vza00_nors_BBO2 = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_nors_BBO2.dat")
rayl_sza70_vza00_nors_BBO2_Δp = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_nors_BBO2_dp.dat")
rayl_sza70_vza00_nors_BBO2_SIF = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza70_vza00_nors_BBO2_SIF.dat")

rayl_sza30_vza00_rrs_BBO2 = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_rrs_BBO2.dat")
rayl_sza30_vza00_nors_BBO2 = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_nors_BBO2.dat")
rayl_sza30_vza00_nors_BBO2_Δp = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_nors_BBO2_dp.dat")
rayl_sza30_vza00_nors_BBO2_SIF = readdlm("/home/sanghavi/CMS_RamanSIF/rayl_sza30_vza00_nors_BBO2_SIF.dat")
...
ν = rayl_sza70_vza00_nors_BBO2[:,1]
...
#kernel = InstrumentOperator.create_instrument_kernel(Normal(0, 0.54), x) #SCIAMACHY resolution of σ=0.54 nm in the O2 A-band 
convfct = ν.^2 / 1e7   # to convert radiance units from mW/m²-str-cm⁻¹ to mW/m²-str-nm

for ctr=1:2
    I70_nors[:,ctr]     .= imfilter(rayl_sza70_vza00_nors_BBO2[:,ctr+1], kernel_ν)
    I70_nors_Δp[:,ctr]  .= imfilter(rayl_sza70_vza00_nors_BBO2_Δp[:,ctr+1], kernel_ν)
    I70_nors_SIF[:,ctr] .= imfilter(rayl_sza70_vza00_nors_BBO2_SIF[:,ctr+1], kernel_ν)
    I70_rrs[:,ctr]      .= imfilter(rayl_sza70_vza00_rrs_BBO2[:,ctr+1], kernel_ν)
    ieI70_rrs[:,ctr]    .= imfilter(rayl_sza70_vza00_rrs_BBO2[:,ctr+4], kernel_ν)

    I30_nors[:,ctr]     .= imfilter(rayl_sza30_vza00_nors_BBO2[:,ctr+1], kernel_ν)
    I30_nors_Δp[:,ctr]  .= imfilter(rayl_sza30_vza00_nors_BBO2_Δp[:,ctr+1], kernel_ν)
    I30_nors_SIF[:,ctr] .= imfilter(rayl_sza30_vza00_nors_BBO2_SIF[:,ctr+1], kernel_ν)
    I30_rrs[:,ctr]      .= imfilter(rayl_sza30_vza00_rrs_BBO2[:,ctr+1], kernel_ν)
    ieI30_rrs[:,ctr]    .= imfilter(rayl_sza30_vza00_rrs_BBO2[:,ctr+4], kernel_ν)
end

#convfct = 1.0#./F₀ # to normalize wrt irradiance 
l = @layout [a1 a2] # ; b1 b2; c1 c2]
p1 = plot(1e7./ν, ((I70_rrs[:,1]+ieI70_rrs[:,1])./I70_nors[:,1] .- 1)*100, linecolor=:red, linewidth=1.5, alpha=0.75, xlims=(685,695), label="RRS")
p1 = plot!(1e7./ν, (I70_nors_Δp[:,1]./I70_nors[:,1] .- 1)*100, linecolor=:green, linewidth=1.5, alpha=0.75, xlims=(685,695), label="Δp")
p1 = plot!(1e7./ν, (I70_nors_SIF[:,1]./I70_nors[:,1] .- 1)*100, linecolor=:blue, linewidth=1.5, alpha=0.75, xlims=(685,695), label = "SIF", ylabel="ΔI [%]", yguidefontsize=8)
...
plot(p1, q1, layout = l, plot_title = "SZA=70ᵒ, ρ=0.05, SIF=0.5 mW/m²/str/nm", titlefont = font(8))
savefig("/home/sanghavi/CMS_RamanSIF/Relative_RRS_dp_SIF_O2Bband_SZA70.png")
#savefig("/home/sanghavi/CMS_RamanSIF/SCIA_Relative_RRS_dp_SIF_O2Bband_SZA70.png")

l = @layout [a1 a2] # ; b1 b2; c1 c2]
p1 = plot(1e7./ν, ((I30_rrs[:,1]+ieI30_rrs[:,1])./I30_nors[:,1] .- 1)*100, linecolor=:red, linewidth=1.5, alpha=0.75, xlims=(685,695), label="RRS")
p1 = plot!(1e7./ν, (I30_nors_Δp[:,1]./I30_nors[:,1] .- 1)*100, linecolor=:green, linewidth=1.5, alpha=0.75, xlims=(685,695), label="Δp")
p1 = plot!(1e7./ν, (I30_nors_SIF[:,1]./I30_nors[:,1] .- 1)*100, linecolor=:blue, linewidth=1.5, alpha=0.75, xlims=(685,695), label = "SIF", ylabel="ΔI [%]", yguidefontsize=8)
...
plot(p1, q1, layout = l, plot_title = "SZA=30ᵒ, ρ=0.05, SIF=0.5 mW/m²/str/nm", titlefont = font(8))
savefig("/home/sanghavi/CMS_RamanSIF/Relative_RRS_dp_SIF_O2Bband_SZA30.png")
#savefig("/home/sanghavi/CMS_RamanSIF/SCIA_Relative_RRS_dp_SIF_O2Bband_SZA30.png")

# ZOOM
l = @layout [a1 a2] # ; b1 b2; c1 c2]
p1 = plot(1e7./ν, ((I70_rrs[:,1]+ieI70_rrs[:,1])./I70_nors[:,1] .- 1)*100, linecolor=:red, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="RRS")
p1 = plot!(1e7./ν, (I70_nors_Δp[:,1]./I70_nors[:,1] .- 1)*100, linecolor=:green, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="Δp")
p1 = plot!(1e7./ν, (I70_nors_SIF[:,1]./I70_nors[:,1] .- 1)*100, linecolor=:blue, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label = "SIF", ylabel="ΔI [%]", yguidefontsize=8)
...
plot(p1, q1, layout = l, plot_title = "SZA=70ᵒ, ρ=0.05, SIF=0.5 mW/m²/str/nm", titlefont = font(8))
savefig("/home/sanghavi/CMS_RamanSIF/Relative_RRS_dp_SIF_O2Bband_SZA70_zoom.png")
#savefig("/home/sanghavi/CMS_RamanSIF/SCIA_Relative_RRS_dp_SIF_O2Bband_SZA70.png")

l = @layout [a1 a2] # ; b1 b2; c1 c2]
p1 = plot(1e7./ν, ((I30_rrs[:,1]+ieI30_rrs[:,1])./I30_nors[:,1] .- 1)*100, linecolor=:red, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="RRS")
p1 = plot!(1e7./ν, (I30_nors_Δp[:,1]./I30_nors[:,1] .- 1)*100, linecolor=:green, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="Δp")
p1 = plot!(1e7./ν, (I30_nors_SIF[:,1]./I30_nors[:,1] .- 1)*100, linecolor=:blue, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label = "SIF", ylabel="ΔI [%]", yguidefontsize=8)
...
plot(p1, q1, layout = l, plot_title = "SZA=30ᵒ, ρ=0.05, SIF=0.5 mW/m²/str/nm", titlefont = font(8))
savefig("/home/sanghavi/CMS_RamanSIF/Relative_RRS_dp_SIF_O2Bband_SZA30_zoom.png")
#savefig("/home/sanghavi/CMS_RamanSIF/SCIA_Relative_RRS_dp_SIF_O2Bband_SZA30.png")
...
plot(p1, layout = l, plot_title = "SZA=30ᵒ, ρ=0.05, SIF=0.5 mW/m²/str/nm", titlefont = font(8))
savefig("/home/sanghavi/CMS_RamanSIF/Relative_RRS_dp_SIF_O2Bband_SZA30_zoom_I.png")
#savefig("/home/sanghavi/CMS_RamanSIF/SCIA_Relative_RRS_dp_SIF_O2Bband_SZA30.png")

# Combined
l = @layout [a1 a2; b1 b2] # ; b1 b2; c1 c2]
p1 = plot(1e7./ν, ((I70_rrs[:,1]+ieI70_rrs[:,1])./I70_nors[:,1] .- 1)*100 .+ 0.17, linecolor=:red, linewidth=1.5, alpha=0.5, xlims=(685,695), ylims=(-0.01,1.25), label="RRS")
p1 = plot!(1e7./ν, (I70_nors_Δp[:,1]./I70_nors[:,1] .- 1)*100 .+ 0.1, linecolor=:green, linewidth=1.5, alpha=0.5, xlims=(685,695), ylims=(-0.01,1.25), label="Δp")
p1 = plot!(1e7./ν, (I70_nors_SIF[:,1]./I70_nors[:,1] .- 1)*100 .- 0.75, linecolor=:blue, linewidth=1.5, alpha=0.5, xlims=(685,695), ylims=(-0.01,1.25), label = "SIF", ylabel="ΔI [%]", yguidefontsize=8)
...
#l = @layout [a1] # ; b1 b2; c1 c2]
p2 = plot(1e7./ν, ((I30_rrs[:,1]+ieI30_rrs[:,1])./I30_nors[:,1] .- 1)*100 .+ 0.07, linecolor=:red, linewidth=1.5, alpha=0.5, xlims=(685,695), ylims=(-0.02,0.4), label="")
p2 = plot!(1e7./ν, (I30_nors_Δp[:,1]./I30_nors[:,1] .- 1)*100 .+ 0.07, linecolor=:green, linewidth=1.5, alpha=0.5, xlims=(685,695), ylims=(-0.02,0.4), label="")
p2 = plot!(1e7./ν, (I30_nors_SIF[:,1]./I30_nors[:,1] .- 1)*100 .- 0.35, linecolor=:blue, linewidth=1.5, alpha=0.5, xlims=(685,695), ylims=(-0.02,0.4), label = "", ylabel="ΔI [%]", yguidefontsize=8)
...
# ZOOM
#l = @layout [a1] # ; b1 b2; c1 c2]
p1z = plot(1e7./ν, ((I70_rrs[:,1]+ieI70_rrs[:,1])./I70_nors[:,1] .- 1)*100 .+ 0.17, linecolor=:red, linewidth=1.5, alpha=0.5, xlims=(685.8,686.2), ylims=(-0.01,0.2), label="")
p1z = plot!(1e7./ν, (I70_nors_Δp[:,1]./I70_nors[:,1] .- 1)*100 .+ 0.1, linecolor=:green, linewidth=1.5, alpha=0.5, xlims=(685.8,686.2), ylims=(-0.01,0.2), label="")
p1z = plot!(1e7./ν, (I70_nors_SIF[:,1]./I70_nors[:,1] .- 1)*100 .- 0.75, linecolor=:blue, linewidth=1.5, alpha=0.5, xlims=(685.8,686.2), ylims=(-0.01,0.2), label = "", ylabel="ΔI [%]", yguidefontsize=8)
...
#l = @layout [a1] # ; b1 b2; c1 c2]
p2z = plot(1e7./ν, ((I30_rrs[:,1]+ieI30_rrs[:,1])./I30_nors[:,1] .- 1)*100 .+ 0.07, linecolor=:red, linewidth=1.5, alpha=0.5, xlims=(685.8,686.2), ylims=(-0.02,0.1), label="")
p2z = plot!(1e7./ν, (I30_nors_Δp[:,1]./I30_nors[:,1] .- 1)*100 .+ 0.07, linecolor=:green, linewidth=1.5, alpha=0.5, xlims=(685.8,686.2), ylims=(-0.02,0.1), label="")
p2z = plot!(1e7./ν, (I30_nors_SIF[:,1]./I30_nors[:,1] .- 1)*100 .- 0.35, linecolor=:blue, linewidth=1.5, alpha=0.5, xlims=(685.8,686.2), ylims=(-0.02,0.1), label = "", ylabel="ΔI [%]", yguidefontsize=8)

#q1 = plot(1e7./ν, ((I30_rrs[:,2]+ieI30_rrs[:,2])./I30_nors[:,2] .- 1)*100, linecolor=:red, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="RRS")
#q1 = plot!(1e7./ν, (I30_nors_Δp[:,2]./I30_nors[:,2] .- 1)*100, linecolor=:green, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="Δp")
#q1 = plot!(1e7./ν, (I30_nors_SIF[:,2]./I30_nors[:,2] .- 1)*100, linecolor=:blue, linewidth=1.5, alpha=0.75, xlims=(685.8,686.2), label="SIF", ylabel="ΔQ [%]", yguidefontsize=8)

plot(p1, p1z, p2, p2z, layout = l, plot_title = "ρ=0.05, Δp=3 hPa, SIF=0.5 mW/m²/str/nm", ploy_titlefont = font(8), title = ["SZA=70ᵒ" "SZA=70ᵒ" "SZA=30ᵒ" "SZA=30ᵒ"], titlefont = font(8))
savefig("/home/sanghavi/CMS_RamanSIF/Relative_RRS_dp_SIF_O2Bband_withzoom_I.pdf")
