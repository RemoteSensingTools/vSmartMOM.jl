    ...
    for iρ = 1:21 #1:15 #3 #1:15
        for iA = 1:14
            ...
            for vctr = 1:length(model.params.vaz)
                ...
                # With SIF
                #fname0 = "/home/sanghavi/data/RamanSIFgrid/OCO/OCOraylSIF_sza"*sza_str*"_vza"*vza_str*"_vaz"*vaz_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_nors_ABO2.dat"
                ##fname1 = "/home/sanghavi/data/RamanSIFgrid/OCO/OCOraylSIF_sza"*sza_str*"_vza"*vza_str*"_vaz"*vaz_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_rrs_ABO2.dat"
                # No SIF
                fname0 = "/home/sanghavi/data/RamanSIFgrid/OCO/OCOrayl_sza"*sza_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_nors_ABO2.dat"
                #fname0 = "/home/sanghavi/data/RamanSIFgrid/OCO/OCOrayl_sza"*sza_str*"_vza"*vza_str*"_vaz"*vaz_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_nors_ABO2.dat"
                #fname1 = "/home/sanghavi/data/RamanSIFgrid/OCO/OCOrayl_sza"*sza_str*"_vza"*vza_str*"_vaz"*vaz_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_rrs_ABO2.dat"
