...
parameters = 
    parameters_from_yaml("/home/sanghavi/code/github/vSmartMOM.jl/test/test_parameters/testCPU.yaml");
...
for isurf = 1:1 # 1:1 #2:2 # 
    for iρ = 1:1#5 #3 #1:15
        for iA = 1:1#4
            ...
            fname0 = "/home/sanghavi/RamanSIFgrid/test1raylSIF_sza"*sza_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_nors_ABO2.dat"
            fname1 = "/home/sanghavi/RamanSIFgrid/test1raylSIF_sza"*sza_str*"_alb"*albedo*"_psurf"*string(psurf[isurf])*"hpa_rrs_ABO2.dat"
