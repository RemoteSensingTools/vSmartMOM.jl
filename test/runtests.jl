...
@testset "RadiativeTransfer.CrossSection" begin
    ...
    @testset "readHITRAN" begin
        ...
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", mol=2, iso=1, ν_min=6000, ν_max=6400)
        ...
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", iso=1, ν_min=6000, ν_max=6400)
        ...
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", mol=2, ν_min=6000, ν_max=6400)
        ...
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", ν_min=6000, ν_max=6400)
        ...
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", mol=2, iso=1, ν_max=6400)
        @test length(test_ht.mol) == 9

        # Not specifying ν_max
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", mol=2, iso=1, ν_min=6000)
        @test length(test_ht.mol) == 7

        # Not specifying ν_min OR ν_max
        test_ht = CrossSection.readHITRAN("helper/testCO2.data", mol=2, iso=1)
