...
include("types_lin.jl")                  # Derivative types used in this module
include("mie_helper_functions.jl")
include("mie_helper_functions_lin.jl")        # Mie file-related functions
include("legendre_functions.jl")          # Recursions for associated Legendre Polynomials
include("truncate_phase.jl")   
include("truncate_phase_lin.jl")              # Functions for truncation
...
include("compute_NAI2_lin.jl")                # Compute phase function w/ NAI2
...
# Export lin types
export linGreekCoefs, linAerosolOptics #, AbstractFourierDecompositionLin
