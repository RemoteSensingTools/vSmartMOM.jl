...
function make_mie_model(computation_type::NAI2,
    ...
    return MieModel(computation_type, aerosol, λ, polarization, truncation_type, r_max, nquad_radius, zeros(1, 1, 1), zeros(1, 1, 1), architecture, precision_policy)
end
...
function make_mie_model(computation_type::PCW,
    ...
    return MieModel(computation_type, aerosol, λ, polarization, truncation_type, r_max, nquad_radius, wigner_A, wigner_B, architecture, precision_policy)
end
