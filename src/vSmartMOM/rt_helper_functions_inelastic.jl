...
"Default matrix in RT calculation (random)"
default_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman)   = arr_type(randn(FT, tuple(dims[1], dims[2], nSpec, nRaman)))

"Default J matrix in RT calculation (random)"
default_J_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman) = arr_type(randn(FT, tuple(dims[1], 1, nSpec, nRaman)))
...
make_added_layer(FT, arr_type, dims, nSpec)     = AddedLayer(default_matrix(FT, arr_type, dims, nSpec), 
                                                         ...
                                                         default_J_matrix(FT, arr_type, dims, nSpec),
                                                         default_matrix_ie(FT, arr_type, dims, nSpec, nRaman), 
                                                         default_matrix_ie(FT, arr_type, dims, nSpec, nRaman), 
                                                         default_matrix_ie(FT, arr_type, dims, nSpec, nRaman),
                                                         default_matrix_ie(FT, arr_type, dims, nSpec, nRaman),
                                                         default_J_matrix_ie(FT, arr_type, dims, nSpec, nRaman),
                                                         default_J_matrix_ie(FT, arr_type, dims, nSpec, nRaman)
                                                         )
...
make_added_layer_rand(FT, arr_type, dims, nSpec)     = AddedLayer(default_matrix_rand(FT, arr_type, dims, nSpec), 
                                                         ...
                                                         default_J_matrix_rand(FT, arr_type, dims, nSpec),
                                                         default_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman), 
                                                         default_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman), 
                                                         default_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman),
                                                         default_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman),
                                                         default_J_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman),
                                                         default_J_matrix_rand_ie(FT, arr_type, dims, nSpec, nRaman)
                                                         )
