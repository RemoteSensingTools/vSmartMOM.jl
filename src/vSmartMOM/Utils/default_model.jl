...
function parameters_from_yaml(file_path)
    ...
    return vSmartMOM_Parameters(FT,
                                ...
                                FT(params_dict["scattering"]["aerosols"][1]["nᵣ"]),
                                FT(params_dict["scattering"]["aerosols"][1]["nᵢ"]),
                                FT(params_dict["scattering"]["aerosols"][1]["p₀"]),
                                FT(params_dict["scattering"]["aerosols"][1]["σp"]),
