...
function rt_run_ms(RS_type::AbstractRamanType, #Default - no Raman scattering (noRS)
    ...
    for m = 0:max_m - 1
        ...
        @showprogress 1 "Looping over layers ..." for iz = 1:Nz  # Count from TOA to BOA
            ...
            rt_kernel_multisensor!(RS_type, sensor_levels, pol_type, SFI, added_layer, composite_layer, computed_layer_properties, m, quad_points, I_static, architecture, qp_μN, iz) 
        end 
