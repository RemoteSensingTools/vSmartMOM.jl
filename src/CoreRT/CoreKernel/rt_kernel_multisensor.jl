...
function rt_kernel_multisensor!(RS_type::noRS, sensor_levels, pol_type, SFI, added_layer, composite_layer, computed_layer_properties, m, quad_points, I_static, architecture, qp_μN, iz) 
    ...
    if (iz == 1)
        for ims = 1:length(sensor_levels)
            if(ims==0)
                composite_layer.botT⁺⁺[ims,:], composite_layer.botT⁻⁻[ims,:] = (added_layer.t⁺⁺, added_layer.t⁻⁻)
                composite_layer.botR⁻⁺[ims,:], composite_layer.botR⁺⁻[ims,:] = (added_layer.r⁻⁺, added_layer.r⁺⁻)
                composite_layer.botJ₀⁺[ims,:], composite_layer.botJ₀⁻[ims,:] = (added_layer.J₀⁺, added_layer.J₀⁻ )
            else
                composite_layer.topT⁺⁺[ims,:], composite_layer.topT⁻⁻[ims,:] = (added_layer.t⁺⁺, added_layer.t⁻⁻)
                composite_layer.topR⁻⁺[ims,:], composite_layer.topR⁺⁻[ims,:] = (added_layer.r⁻⁺, added_layer.r⁺⁻)
                composite_layer.topJ₀⁺[ims,:], composite_layer.topJ₀⁻[ims,:] = (added_layer.J₀⁺, added_layer.J₀⁻ )
            end
        end
...
# Perform the Core RT routines (elemental, doubling, interaction)
function rt_kernel_multisensor!(RS_type::Union{RRS, VS_0to1, VS_1to0}, sensor_levels, pol_type, SFI, added_layer, composite_layer, computed_layer_properties, m, quad_points, I_static, architecture, qp_μN, iz) 
    ...
    if (iz == 1)
        for ims=1:length(sensor_levels)
            if(ims==0)
                ...
                composite_layer.botR⁻⁺[ims,:], composite_layer.botR⁺⁻[ims,:] = (added_layer.r⁻⁺, added_layer.r⁺⁻)
                composite_layer.botJ₀⁺[ims,:], composite_layer.botJ₀⁻[ims,:] = (added_layer.J₀⁺, added_layer.J₀⁻ )
                composite_layer.botieT⁺⁺[ims,:], composite_layer.botieT⁻⁻[ims,:] = (added_layer.iet⁺⁺, added_layer.iet⁻⁻)
                composite_layer.botieR⁻⁺[ims,:], composite_layer.botieR⁺⁻[ims,:] = (added_layer.ier⁻⁺, added_layer.ier⁺⁻)
                composite_layer.botieJ₀⁺[ims,:], composite_layer.botieJ₀⁻[ims,:] = (added_layer.ieJ₀⁺, added_layer.ieJ₀⁻ )
            else
                composite_layer.topT⁺⁺[ims,:], composite_layer.topT⁻⁻[ims,:] = (added_layer.t⁺⁺, added_layer.t⁻⁻)
                composite_layer.topR⁻⁺[ims,:], composite_layer.topR⁺⁻[ims,:] = (added_layer.r⁻⁺, added_layer.r⁺⁻)
                composite_layer.topJ₀⁺[ims,:], composite_layer.topJ₀⁻[ims,:] = (added_layer.J₀⁺, added_layer.J₀⁻ )
                composite_layer.topieT⁺⁺[ims,:], composite_layer.topieT⁻⁻[ims,:] = (added_layer.iet⁺⁺, added_layer.iet⁻⁻)
                composite_layer.topieR⁻⁺[ims,:], composite_layer.topieR⁺⁻[ims,:] = (added_layer.ier⁻⁺, added_layer.ier⁺⁻)
                composite_layer.topieJ₀⁺[ims,:], composite_layer.topieJ₀⁻[ims,:] = (added_layer.ieJ₀⁺, added_layer.ieJ₀⁻ )
            end
        end
    # If this is not the TOA, perform the interaction step
    else
...
function rt_kernel_multisensor!(RS_type::Union{RRS{FT}, VS_0to1{FT}, VS_1to0{FT}}, sensor_levels, pol_type, SFI, added_layer, composite_layer, computed_layer_properties::CoreScatteringOpticalProperties, scattering_interface, τ_sum,m, quad_points, I_static, architecture, qp_μN, iz)  where {FT}
    @unpack qp_μ, μ₀ = quad_points
    # Just unpack core optical properties from 
    @unpack τ, ϖ, Z⁺⁺, Z⁻⁺ = computed_layer_properties
    # SUNITI, check? Also, better to write function here
