...
For a full runnable walkthrough, see the [absorption tutorial](../tutorials/Tutorial_Absorption.md). Public docstrings are grouped in the [Absorption API](../api/absorption.md).
