...
Usage:
    ...
    julia --project=. sandbox/workflows/RRS_XCO2/inversion/retrieval_setup/build_apriori.jl \
...
const OUTPUT_ROOT = joinpath(RRS_ROOT, "inversion", "retrieval_setup")
const OUTPUT = joinpath(OUTPUT_ROOT, "apriori_states.nc")
const SUMMARY = joinpath(OUTPUT_ROOT, "apriori_states.dat")
