...
const DEFAULT_COEFFICIENT_PATH = normpath(get(
    ENV, "OCO_STOKES_COEFFICIENTS",
    joinpath(RRSXCO2Common.ROOT, "inversion", "instrument",
             "representative_stokes_coefficients.nc")))
const DEFAULT_COMPONENT_PATH = normpath(get(
    ENV, "RRS_XCO2_COMPONENTS",
    joinpath(RRSXCO2Common.ROOT, "truth_map", "scene_components.dat")))
"""
