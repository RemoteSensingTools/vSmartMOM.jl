...
OUTPUT = HERE / "state001_corrected_vs_uncorrected_compact_state.png"
TABLE = HERE / "state001_corrected_vs_uncorrected_compact_state.dat"
...
def load_class(retrieval_class):
    records = []
    for path in sorted(
        (HERE / retrieval_class).glob("retrieval_state001_perturbation*.nc")
    ):
